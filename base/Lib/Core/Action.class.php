...
abstract class Action {
   ...
   /**
    ...
    protected function display($templateFile='',$charset='',$contentType='') {
        if(empty($this->data)&&!$_POST){
            if(method_exists($this,'blank')){
                $this->blank();
                exit;
            }
        }
        ...
        $this->assign('res',str_replace(APP_ROOT,'',TMPL_PATH).GROUP_NAME.'/'.(cookie('ynw_theme')==''?'default':cookie('ynw_theme')).'/Res/');
