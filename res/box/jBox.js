...
function jBox(type, options) {
	...
	this.options = {
		...
		delayClose: 12,				// Delay closing in ms (Note that there is always a closing delay of at least 10ms to ensure jBox won't be closed when opening right away)
	...
	this._addOverlay = function() {
		...
		// Show overlay
		this.options.fade ? (this.overlay.stop() && this.overlay.animate({opacity: 0.4}, {
			queue: false,
